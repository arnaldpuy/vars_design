...
## ----ishi, cache=TRUE, dependson=c("star", "settings")---------------
...
## ----sobolG, cache=TRUE, dependson = c("star", "settings")-----------
...
## ----morris, cache=TRUE, dependson = c("star", "settings")-----------
